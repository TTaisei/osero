...
void print(FILE * fp1, FILE * fp2, FILE * fp3);
...
void main(void) {
    ...
    FILE * fp1, * fp2, * fp3;
    if (PLAYER == BLACK){
        fp1 = fopen("whitedata1.txt", "w");
        fp2 = fopen("whitedata2.txt", "w");
        fp3 = fopen("whitedata3.txt", "w");
    }else{
        fp1 = fopen("blackdata1.txt", "w");
        fp2 = fopen("blackdata2.txt", "w");
        fp3 = fopen("blackdata3.txt", "w");
    }
...
void print(FILE * fp1, FILE * fp2, FILE * fp3){
    ...
    for (int i = 0; i < SIZE * SIZE - 4; i++){
        if (score_arr[i][2] == my){
            if (i < 20){
                fprintf(fp1, "%3d", i);
                fprintf(fp1, "%3d%3d", score_arr[i][0], score_arr[i][1]);
                fprintf(fp1, "%d\n", point[i]);
            }else if (i < 40){
                fprintf(fp2, "%3d", i);
                fprintf(fp2, "%3d%3d", score_arr[i][0], score_arr[i][1]);
                fprintf(fp2, "%d\n", point[i]);            
            }else{
                fprintf(fp3, "%3d", i);
                fprintf(fp3, "%3d%3d", score_arr[i][0], score_arr[i][1]);
                fprintf(fp3, "%d\n", point[i]);
            }
